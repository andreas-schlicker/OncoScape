...
getOptionList = function(options) {
	...
	all = list(config=make_option(c("-c", "--config"), type="character", help="Configuration file"),
			   ...
			   cancer=make_option(c("-a", "--cancer"), type="character", help="Comma-separated list of cancer types to test", default="all"),
			   ...
			   methylation=make_option(c("-m", "--methylation"), type="character", help="Resolution of methylation data (base, region or region_filtered)", default="base"),
