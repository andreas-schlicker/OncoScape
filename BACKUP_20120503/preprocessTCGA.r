...
# Imports TCGA level 3 somatic mutation data.
# filename is a string giving the name of the file to import
importSomMutLevel3 = function(filename) {
  input = read.table(filename, sep="\t", header=TRUE, stringsAsFactors=FALSE)
